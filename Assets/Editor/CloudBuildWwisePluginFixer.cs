...
public class WwiseFixEditor : MonoBehaviour
{
    ...
    private static WwiseReplacement[] WwisePatches =
    {
      ...
      new WwiseReplacement("#if UNITY_EDITOR_WIN || (UNITY_STANDALONE_WIN && !UNITY_EDITOR) || UNITY_WSA", "#if UNITY_STANDALONE_WIN || UNITY_EDITOR_WIN || UNITY_WSA"),
      //Linux
      new WwiseReplacement("#if UNITY_STANDALONE_LINUX && ! UNITY_EDITOR", "#if UNITY_EDITOR || (UNITY_STANDALONE_LINUX && !UNITY_EDITOR)"),
      new WwiseReplacement("#if UNITY_STANDALONE_LINUX && !UNITY_EDITOR", "#if UNITY_EDITOR || (UNITY_STANDALONE_LINUX && !UNITY_EDITOR)"),
      // Android
